...
public class MFAEmailOTPWebKeys {
	...
	public static final String MFA_MOBILE_NUMBER_OTP_SEND_TO_NUMBER_OBFUSCATED =
			"MFA_MOBILE_NUMBER_OTP_SEND_TO_NUMBER_OBFUSCATED";

	public static final String OTP_MEDIUM =
			"OTP_MEDIUM";

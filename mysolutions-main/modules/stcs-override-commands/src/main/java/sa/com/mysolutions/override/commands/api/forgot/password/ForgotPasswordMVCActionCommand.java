...
package sa.com.mysolutions.override.commands.api.forgot.password;
...
public class ForgotPasswordMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		System.out.println("Inside  ForgotPasswordMVCActionCommand");
		...
		try {
			if (_prefsProps.getBoolean(
				...
				redirectURL.setParameter("jspPage", "/forgot_page.jsp");
			}
		}

...
import sa.com.mysolutions.override.commands.api.CommonUtil;
...
public class EmailOTPBrowserMFAChecker implements BrowserMFAChecker {
	...
	public void includeBrowserVerification(
		...
		_log.info("mobile : "+"9892098920");
		
		//code to send masked mobile number
		httpServletRequest.setAttribute(
				MFAEmailOTPWebKeys.MFA_MOBILE_NUMBER_OTP_SEND_TO_NUMBER_OBFUSCATED,
				obfuscateMobileNumber("9892098920"));
		
		//code to send default otp medium in otp page
		httpServletRequest.setAttribute(
				MFAEmailOTPWebKeys.OTP_MEDIUM,(CommonUtil.getUserCustomFieldRadioValue(user, "Default OTP Medium")));
	...
	//mask mobile number
	protected static String obfuscateMobileNumber(String mobileNumber) {
		String strPattern = "\\d(?=\\d{3})";
		return mobileNumber.replaceAll(strPattern, "*");
	}

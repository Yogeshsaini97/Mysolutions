                ...
                <div class="popupImage" style="    display: flex;">
                    <div >
                            <div class="modal-header border-0 pb-0">
                              <button type="button" @click=" downloadingLoaderfailure=false;
                              " class="close opacity-100" data-dismiss="modal" aria-label="Close">
                                <img :src="'/documents/d/mysolutions/icon-cross'" alt="img" />
                              </button>
                            </div>
                            <div class="modal-body pt-1 pl-50 pr-50 pb-50">
                              <h4 class="modal-title mb-2 text-default">{{ i18n.global.t('OOPS_SOMETHING_WENT_WRONG_PLEASE_TRY_AGAIN') }}</h4>
...
const downloadingLoaderfailure=inject('downloadingLoaderfailure')

...
import RiskListTable from "../views/risks/show-risks-details.ce.vue";
import IssuesListTable from "../views/issues/show-issue-details.ce.vue";
import ScheduleListTable from "../views/schedule/show-schedule-details.ce.vue";
import ProjectDocumentsListTable from "../views/documents/show-documents-details.ce.vue";
import ProjectApprovalListTable from "../views/approvals/show-approvals-details.ce.vue";
import ProjectInvoiceListTable from "../views/invoices/show-invoices-details.ce.vue";

import StakeholdersListTable from "../views/stakeholders/show-stakeholders-details.ce.vue";

import MilestonesListTable from "../views/milestones/show-milestones-details.ce.vue";
...
props: {
  ...
  components: { headerlist, ProjectListTable, RiskListTable,IssuesListTable, ScheduleListTable, ProjectDocumentsListTable, ProjectApprovalListTable, ProjectInvoiceListTable, StakeholdersListTable, MilestonesListTable,Loader,TableSkeletonLoader }
};
</script>
              ...
              <div class="">
                ...
                <div >
                  ...
                  <div v-if="openRiskList">
                    <RiskListTable :hostUrl="hostUrl" />
                  </div>
                  <div v-if="openIssueList">
                    <IssuesListTable :hostUrl="hostUrl" />
                  </div>

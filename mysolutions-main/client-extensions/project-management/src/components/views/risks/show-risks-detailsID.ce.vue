      ...
      align-items: flex-end;">
        <h4 class="modal-title mb-0 text-default line-height-8 risk-ml">{{
          i18n.global.t('PROJECT_RISKS_DETAILS.RISK_DETAIL') }}<br /><span
            class="text-dark font-12 font-weight-800 opacity-60">{{ i18n.global.t('ID') }}-{{ RiskId ? RiskId : "N/A" }}</span></h4>
      ...
      <div class="modal-body px-40">
        <div class="row">
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.TITLE') }}</p>
            <p class="mb-0">{{ RiskData?.title }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.PRIORITY') }}</p>
            <div class="d-flex align-center" v-if="RiskData?.priority?.split(')')[1] == ' Critical' || RiskData?.priority?.split(')')[1] == ' Very High'">
          ...
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.STATUS') }}</p>
          ...
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.RISK_PROBABILITY') }}</p>
            <div class="d-flex align-center">
              ...
              <div class="d-flex align-center" v-if="RiskData?.probability?.split(')')[1] == ' Medium'">
                <div v-for="i in 2" :key="i" class="circle circle-orange"></div>
                <div v-for="i in 2" :key="i" class="circle "></div>
                <p class="mb-0 ml-2 text-orange">{{ RiskData?.probability?.split(')')[1]}}</p>
              </div>
          ...
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.RISK_SEVERITY') }}</p>
            <div class="d-flex align-center">
          ...
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.CATEGORY') }}</p>
            <p class="mb-0">{{ RiskData?.category }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2">{{ i18n.global.t('PROJECT_RISKS_DETAILS.ASSIGNED_TO') }}</p>
            <p class="mb-0">{{ RiskData?.assignedTo }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.OWNER') }}</p>
        ...
        <div class="row">
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2">{{ i18n.global.t('PROJECT_RISKS_DETAILS.DESCRIPTION') }}</p>
            <p class="mb-0">{{ RiskData?.description }}.</p>
          </div>
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2">{{ i18n.global.t('PROJECT_RISKS_DETAILS.MITIGATION_PLAN') }}</p>
            <p class="mb-0">{{ RiskData?.mitigationPlan }}.</p>
          </div>
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2">{{ i18n.global.t('PROJECT_RISKS_DETAILS.CONTINGENCY_PLAN') }}</p>
        ...
        <div class="row">
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2">{{ i18n.global.t('PROJECT_RISKS_DETAILS.REQUESTED_ON') }}</p>
            <p class="mb-0">{{ ChangeDateFormat(RiskData?.created) }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2">{{ i18n.global.t('PROJECT_RISKS_DETAILS.REQUESTED_BY') }}</p>
            <p class="mb-0">{{ RiskData?.createdBy }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.DUE_DATE') }}</p>
            <p class="mb-0">{{ ChangeDateFormat(RiskData?.dueDate) }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 font-weight-800 mb-2"> {{ i18n.global.t('PROJECT_RISKS_DETAILS.CLOSING_DATE') }}</p>
...
export default {
  ...
  setup(props) {
    ...
    const hostUrl = import.meta.env.VITE_TESTING_LIFERAY_ROOT_API +`ods/epm/risk?riskID=${props.id}%26projectID=${ProjectApiId.value}&p_auth=${Liferay.authToken}`;
  ...
  components: {TableSkeletonLoader, ErrorMessageDialogBox }
}
</script>

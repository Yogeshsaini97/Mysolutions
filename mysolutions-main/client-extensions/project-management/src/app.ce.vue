...
<style src="./assets/Style/filters.css"></style>
<style src="./assets/Style/server.css"></style>
<style src="./assets/Style/responsive.css"></style>
<style>
...
import * as authenticatedPermissions from './authenticatedPermissions.json';
...
const stakeholdercustomerName = ref(null);
provide("stakeholdercustomerName", stakeholdercustomerName)
...
const getUserRoles = async () => {
  if (Liferay?.ThemeDisplay?.getUserEmailAddress()) {
    ...
    selectedCrNumber.value = '1010504644';
  }
}
...
const authenticatedUsersPermission = ref(authenticatedPermissions.projectManagementActions
);
provide("authenticatedUsersPermissions", authenticatedUsersPermission);

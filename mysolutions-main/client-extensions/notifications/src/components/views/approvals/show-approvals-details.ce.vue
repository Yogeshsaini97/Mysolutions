<template >
    ...
    <table class="table font-weight-600">
      <thead v-if="showHideHeader">
        <tr>
          ...
          <th>{{ i18n.global.t('PROJECT_APPROVALS.TITLE_&_ID') }}</th>
  ...
  item.approvalType   : 'N/A' }}</span></td> -->

          <td> <span v-if="item?.approvalType == 0" class="badge rounded-pill font-10 bg-light-orange   "><i
                class='fa-solid fa-circle font-5 align-middle mr-2'></i>Pending</span>
            <span v-if="item?.approvalType == 1" class="badge rounded-pill font-10 bg-light-success   "><i
                class='fa-solid fa-circle font-5 align-middle mr-2'></i>Approved</span>
            <span v-if="item?.approvalType == 2" class="badge rounded-pill font-10 bg-light-danger   "><i
                class='fa-solid fa-circle font-5 align-middle mr-2'></i>Rejected</span>
          </td>


          <td v-if="item?.approvalState == 0" class="font-weight-800">Schedule</td>

          <td v-if="item?.approvalState == 1" class="font-weight-800">Milestone</td>

          <td v-if="item?.approvalState == 2" class="font-weight-800">Document</td>


          <td v-if="item?.approvalState == 0">Schedule<br /></td>
          <td v-if="item?.approvalState == 1">Milestone<br /></td>
          <td v-if="item?.approvalState == 2">Document<br /></td>
      ...
      <tbody v-else-if="approvalData != null && approvalData.key == 'server error'">
        <tr>
          ...
          <ErrorMessageDialogBox WarningMessage="Oopss!!"

        ...
        item.id : 'N/A' }}</span></td>
            ...
            <tbody v-else-if="ProjectsData=='Success' || ProjectsData=='N/A' ">
                <tr>
                    ...
                    <ErrorMessageDialogBox WarningMessage="Hello! " message="Hello! Looks like you doesn't have any Project Right now!"  btnmsg="add one" :showHideHeaderfunc="showHideHeaderfunc"/>

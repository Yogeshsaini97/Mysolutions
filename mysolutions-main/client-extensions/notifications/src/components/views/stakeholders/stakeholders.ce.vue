...
const stakeholdersUrl = import.meta.env.VITE_TESTING_LIFERAY_ROOT_API + `ods/epm/stakeholder/stakeholder-list?projectID=${ProjectApiId.value}`;
...
<template>
  ...
  <div class="row">
    <div class="col-md-3 border-right">
      ...
      <div class="mt-4">
        <p class="mb-1 text-default font-weight-600">{{ i18n.global.t('STAKEHOLDER.PROJECT_TITLE') }} & {{
          i18n.global.t('STAKEHOLDER.ID') }}</p>
      ...
      <div class=" bg-light shadow-none rounded-0 mnh-140p mt-4">
        <div class="card-body">
          ...
          <p class="mb-0 font-8 opacity-60">{{ i18n.global.t('STAKEHOLDER.CUSTOMERS') }} <span class="text-danger"></span>
          </p>
        </div>
      </div>
      <div class="bg-light shadow-none rounded-0 mnh-140p mt-4">

      ...
      <div class="modal-header px-40 pt-40 pb-4" style="display: flex;
        ...
        <h4 class="modal-title mb-0 text-default line-height-8">{{
          i18n.global.t('PROJECT_ISSUE_DETAILS.ISSUE_DETAIL') }}<br /><span
            class="text-dark font-12 opacity-60">STCS-{{ IssueId ? IssueId : "N/A" }}</span></h4>
      ...
      <div class="modal-body px-40">
        <div class="row">
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.TITLE') }}</p>
            <p class="mb-0">{{ IssueData?.title }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.PRIORITY') }}</p>
          ...
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.STATUS') }}</p>
          ...
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.ISSUE_PROBABILITY') }}</p>
            <div class="d-flex align-center">
              ...
              <div class="d-flex align-center" v-if="IssueData?.probability == ' Low'">
                <div v-for="i in 1" :key="i" class="circle circle-grey"></div>
                <div v-for="i in 3" :key="i" class="circle "></div>
                <p class="mb-0 ml-2 text-grey">{{ IssueData?.probability?.split(")")[1] }}</p>
              </div>
          ...
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.ISSUE_SEVERITY') }}</p>
            <div class="d-flex align-center">
          ...
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.CATEGORY') }}</p>
            <p class="mb-0">{{ IssueData?.category }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2">{{ i18n.global.t('PROJECT_ISSUE_DETAILS.ASSIGNED_TO') }}</p>
            <p class="mb-0">{{ IssueData?.assignedTo }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.OWNER') }}</p>
        ...
        <div class="row">
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 mb-2">{{ i18n.global.t('PROJECT_ISSUE_DETAILS.DESCRIPTION') }}</p>
            <p class="mb-0">{{ IssueData?.discussion }}.</p>
          </div>
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 mb-2">{{ i18n.global.t('PROJECT_ISSUE_DETAILS.MITIGATION_PLAN') }}</p>
            <p class="mb-0">{{ IssueData?.mitigationPlan }}.</p>
          </div>
          <div class="col-12 col-md-12 mb-4">
            <p class="text-default font-12 mb-2">{{ i18n.global.t('PROJECT_ISSUE_DETAILS.CONTIGENCY_PLAN') }}</p>
            <p class="mb-0">{{ IssueData?.contingencyPlan }}.</p>
          </div>
        </div>
        <hr class="mt-0 mb-4" />
        <div class="row">
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2">{{ i18n.global.t('PROJECT_ISSUE_DETAILS.REQUESTED_ON') }}</p>
            <p class="mb-0">{{ ChangeDateFormat(IssueData?.creationDate) }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2">{{ i18n.global.t('PROJECT_ISSUE_DETAILS.REQUESTED_BY') }}</p>
            <p class="mb-0">{{ IssueData?.createdBy }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.DUE_DATE') }}</p>
            <p class="mb-0">{{ ChangeDateFormat(IssueData?.dueDate) }}</p>
          </div>
          <div class="col-12 col-md-6 mb-4">
            <p class="text-default font-12 mb-2"> {{ i18n.global.t('PROJECT_ISSUE_DETAILS.CLOSING_DATE') }}</p>
...
export default {
  ...
  setup(props) {
    ...
    const hostUrl = import.meta.env.VITE_TESTING_LIFERAY_ROOT_API +`ods/epm/issue?issueID=${IssueId}%26projectID=${ProjectApiId.value}`;

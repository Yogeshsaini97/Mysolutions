        ...
        <div class=" backbuttonfix d-flex">
          ...
          <div class="ml-3">
            <h4 class="mb-0 font-weight-600">{{
              breadcrumbs[1] ? breadcrumbs[1].label : i18n.global.t('ACTIVITY_LOG') }}</h4>
            ...
            <p class="breadcrumbmain mb-0 font-10">
              ...
              <li  v-for="(item, index) in breadcrumbs" :key="index">
               ...
               color: white;" :href="item.Link"> <span> <img :src="'/documents/d/mysolutions/angle-right'"
                   ...
                   <span data-toggle="tooltip" data-placement="bottom" :title="i18n.global.t('CLICK_TO_VIEW_ACTIVITY_LOGS')"> {{ i18n.global.t(item.label) }}</span></span></a>
              </li>
            </p>
          </div>
        </div>
...
import LoadingPopupcontactSuccess from './LoadingTalktoUs.ce.vue';

...
const hostUrl=`/o/c/activitylogs/scopes/20119?fields=creator,id,title,user,description,dateCreated&restrictFields=actions&filter=user eq ${Liferay?.ThemeDisplay?.getUserId() || '20123'}`;
...
<template>
  <div  data-toggle="tooltip" data-placement="bottom" title="" class="row">
    <div class="col-md-3 border-right">
      <h2 class="my-4 line-height-15">{{ i18n.global.t('ACTIVITY') }}<br />{{ i18n.global.t('LOG') }}</h2>

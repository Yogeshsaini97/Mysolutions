          ...
          <div @click="GoToPage('projects')" class="col-md-4 pointer">
            ...
            <div class="card mnh-140p mb-40">
              ...
              <div class="card-body" v-if="loader == false">
                ...
                align-items: stretch;
                justify-content: space-between;" >  <p class="mb-0 font-40 text-default" style="margin:0px 0px 0px -5px;">{{ projectStatus != 'server error' ? ProjectsJSON.inProgress :
                  'N/A' }}</p>
          ...
          <div @click="GoToPage('projects')" class="col-md-4 pointer">
            ...
            <div class="card mnh-140p mb-40">
              ...
              <div class="card-body" v-if="loader == false">
                ...
                align-content: center;
                align-items: stretch;
                justify-content: space-between;" >  <p class="mb-0 font-40 text-default" style="margin:0px 0px 0px -5px;">{{ projectStatus != 'server error' ? ProjectsJSON.onHold :
                  'N/A' }}</p>
                  <div class="col-md-6  d-flex justify-content-end " style="margin: -17px -31px 0px 0px;">
          ...
          <div @click="GoToPage('projects')" class="col-md-4 pointer">
            ...
            <div class="card mnh-140p mb-40">
              ...
              <div class="card-body" v-if="loader == false">
                ...
                align-content: center;
                align-items: stretch;
                justify-content: space-between;" >  <p class="mb-0 font-40 text-default" style="margin:0px 0px 0px -5px;">{{ projectStatus != 'server error' ? ProjectsJSON.Completed :
                  'N/A' }}</p>
                  <div class="col-md-6  d-flex justify-content-end " style="margin: -17px -31px 0px 0px;">
          ...
          <div @click="GoToPage('projects')" class="col-md-4 pointer">
            ...
            <div class="card mnh-140p mb-40">
              ...
              <div class="card-body" v-if="loader == false">
                ...
                align-content: center;
                align-items: stretch;
                justify-content: space-between;" >  <p class="mb-0 font-40 text-default" style="margin:0px 0px 0px -5px;">{{ projectStatus != 'server error' ? ProjectsJSON.closed :
                  'N/A' }}</p>
                  <div class="col-md-6  d-flex justify-content-end " style="margin: -17px -31px 0px 0px;">
